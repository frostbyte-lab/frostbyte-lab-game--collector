...
export const PLUGINS: EditorPlugin[] = [
  ...
  { id: 'ai-assistant', name: 'AI Assistant', description: 'Integrasi AI cloud tersedia di aplikasi web; belum aktif di APK offline.', category: 'AI', enabledByDefault: false, availableOffline: false, requiresNetwork: true },
